...
app.config['MAIL_USERNAME'] = 'shauryadamathia@gmail.com'  # my email
app.config['MAIL_PASSWORD'] = 'wqko xses aaua oxzw'  # my app password
app.config['MAIL_DEFAULT_SENDER'] = 'sdamathia_be22@thapar.edu'  # my email 
mail = Mail(app)
